/**
 * Disconnect Supabase service
 * POST /api/projects/[id]/services/supabase/disconnect
 */
...
export async function POST(
  ...
  // Delete all related assets first (cascade should handle this, but being explicit)
  await serviceClient
    .from('service_assets')
    .delete()
  ...
  if (error) {
    console.error('[Supabase Disconnect] Error deleting connection:', error)
    return NextResponse.json(
