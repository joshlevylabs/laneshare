...
export function DocumentDetailView({
      ...
      const response = await fetch(
        `/api/projects/${projectId}/documents/${document.id}`,
        {
          ...
          body: JSON.stringify({
            ...
            // Mark as user edited if this is an auto-generated doc
            ...(document.source_repo_id && { user_edited: true }),
          }),
        }
      )
  ...
  const isAutoGenerated = !!document.source_repo_id
      ...
      <div className="flex gap-6">
        ...
        <Card className="flex-1">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-2">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {document.source_repo && (
                    <Badge variant="outline" className="gap-1">
                      <FolderGit2 className="h-3 w-3" />
                      {document.source_repo.name}
                    </Badge>
                  )}
                </div>
                {isEditing ? (
          ...
          <CardContent className="p-6">
            {/* Review Tools for auto-generated docs */}
            {isAutoGenerated && !isEditing && (
              <DocumentReviewTools
                projectId={projectId}
                document={{
                  id: document.id,
                  ...
                  original_markdown: document.original_markdown,
                  evidence_json: document.evidence_json,
                  verification_score: document.verification_score,
                  needs_review: document.needs_review,
                  reviewed: document.reviewed,
                  reviewed_at: document.reviewed_at,
                  user_edited: document.user_edited,
                  user_edited_at: document.user_edited_at,
